          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text('Test Actions', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  IconButton(
                    icon: const Icon(Icons.refresh),
                    onPressed: () => taskQueueService.refresh(),
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        if (task.externalTaskId != null)
                          Text('Ext ID: ${task.externalTaskId}', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                      ],
                    ),
